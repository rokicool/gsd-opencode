 ...
 * 
 * NOTE: This constant will be replaced dynamically based on detected structure in a
 * future update. Currently maintains backward compatibility with 'command' (singular).
 * Use StructureDetector.getCommandDir() to get the appropriate directory name.
 * 
 * @type {string[]}
 */
