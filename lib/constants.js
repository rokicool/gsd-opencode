 ...
 * 
 * NOTE: The command directory is determined dynamically based on detected structure.
 * Use StructureDetector to determine whether to use 'command' (old) or 'commands' (new).
 * This constant lists the base directories; the actual command directory is selected
 * at runtime based on STRUCTURE_TYPES.
 * 
 * @type {string[]}
 */
