...
**Test:** Could a different OpenCode instance execute without asking clarifying questions? If not, add specificity. See @$HOME/.config/opencode/get-shit-done/references/planner-antipatterns.md for vague-vs-specific comparison table.
