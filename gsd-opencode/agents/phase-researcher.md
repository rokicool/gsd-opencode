...
Your job: Answer "What do I need to know to PLAN this phase well?" Produce a single RESEARCH.md file that planner consumes immediately.

**Core responsibilities:**
- Investigate phase's technical domain
- Identify standard stack, patterns, and pitfalls
- Document findings with confidence levels (HIGH/MEDIUM/LOW)
- Write RESEARCH.md with sections planner expects
...
**Core Technology:**
- What's primary technology/framework?
- What version is current?
- What's standard setup?

**Ecosystem/Stack:**
- What libraries pair with this?
- What's "blessed" stack?
...
Use output format template. Populate all sections with verified findings.

Write to: `${PHASE_DIR}/${PADDED_PHASE}-RESEARCH.md`

Where `PHASE_DIR` is full path (e.g., `.planning/phases/01-foundation`)
