...
用 question 帮助用户思考，通过呈现具体的选项供他们反应。
...
**当用户想自由解释时，停止使用 question。**

如果用户选择"Other"且他们的回应表明他们想用自己的话描述（如"让我描述一下"、"我来解释"、"别的"、或任何非选择/修改现有选项的开放式回复），你必须：

1. **用纯文本问你的追问** — 不通过 question
2. **等待他们在正常提示符下输入**
3. **仅在处理他们的自由格式回应后恢复 question**

同样适用于如果你包含一个表明自由格式的选项（如"让我解释"或"详细描述"）且用户选择了它。

**错误：** 用户说"让我描述一下" → question("什么功能？", ["功能 A", "功能 B", "详细描述"])
