...
| `--text` | No | Text-mode fallback — replace interactive prompts with numbered lists (for non-OpenCode runtimes) |
...
/gsd-sketch --text "onboarding flow"    # Non-OpenCode runtime
```
