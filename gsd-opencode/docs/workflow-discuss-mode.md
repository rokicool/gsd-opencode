...
The original interview-style flow. OpenCode identifies gray areas in the phase, presents them
...
A codebase-first flow. OpenCode deeply analyzes the codebase via a subagent (reading 5-15
...
3. **Surface assumptions** — Each assumption includes:
   - What OpenCode would do and why (citing file paths)
