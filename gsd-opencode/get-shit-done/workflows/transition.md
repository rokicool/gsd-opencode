...
Mark current phase complete and advance to next. This is natural point where progress tracking and PROJECT.md evolution happen.
...
Parse current position to verify we're transitioning right phase.
...
If prompts were generated for phase, they stay in place.
...
5. **"What This Is" still accurate?**
   - If product has meaningfully changed, update description
...
- [ ] Last activity describes transition
...
Update date and current focus to reflect transition.
</step>
...
Read ROADMAP.md file and extract:
...
Count total phases and identify highest phase number in milestone.
