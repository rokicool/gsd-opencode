...
2. **gsd-planner** — Reads CONTEXT.md to know WHAT decisions are locked
   ...
   - "AI Discretion: loading skeleton" → planner can decide approach
...
2. **Ask 4 questions using :**
   - header: "[Area]"
   - question: Specific decision for this area
   - options: 2-3 concrete choices ( adds "Other" automatically
