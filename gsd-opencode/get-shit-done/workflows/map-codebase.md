...
Output: .planning/codebase/ folder with 7 structured documents about codebase state.
</purpose>
...
**CRITICAL:** Use dedicated `gsd-codebase-mapper` agent, NOT `Explore`. The mapper agent writes documents directly.
...
If any agent failed, note that failure and continue with successful documents.
</step>
