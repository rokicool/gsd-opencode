...
allowed-tools: [Read, Write, Bash, Glob, Grep, question]
---
```
...
Always use question with concrete options. Never plain text prompts.
...
11. **question for all exploration** — always options
