...
**Purpose:** Document how code is organized at a conceptual level. Complements STRUCTURE.md (which shows physical file locations).
...
[Describe conceptual layers and their responsibilities]
...
[Describe typical request/execution lifecycle]
...
[Core concepts/patterns used throughout codebase]
...
Include file paths as concrete examples of abstractions. Use backtick formatting: `src/services/user.ts`. This makes architecture document actionable for OpenCode when planning.
...
- Adding new features (where does it fit in layers?)
