...
Template for `.planning/codebase/STACK.md` - captures technology foundation.

**Purpose:** Document what technologies run this codebase. Focused on "what executes when you run a code."
