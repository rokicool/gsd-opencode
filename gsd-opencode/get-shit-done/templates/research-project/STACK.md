...
Template for `.planning/research/STACK.md` — recommended technologies for project domain.
<template>
...
- Explain why this is standard choice, not just what it does
...
- Explain to specific problem, not just "it's old"
- Provide to recommended alternative
