...
Template for `.planning/research/FEATURES.md` — feature landscape for project domain.
<template>
...
- **[Feature A] requires [Feature B]:** [why dependency exists]
