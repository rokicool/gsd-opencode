...
Template for `.planning/research/ARCHITECTURE.md` — system structure patterns for project domain.
<template>
...
**Example:**
```typescript
// [Brief code example showing pattern]
```
...
- Explain rationale for grouping
- Match conventions of chosen stack
