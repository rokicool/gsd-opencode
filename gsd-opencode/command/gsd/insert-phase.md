---
description: Insert urgent work as decimal phase (e.g., 7.2) between existing phases
...
Uses decimal numbering (7.2, 7.3, etc.) to preserve the logical sequence of planned phases while accommodating urgent insertions.
