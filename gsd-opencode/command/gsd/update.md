...
You're already on to latest version.
```
...
You're ahead of latest release (development version?).
```
...
Clear to update cache so statusline indicator disappears:
...
⚠️  Restart OpenCode to pick up to new commands.
