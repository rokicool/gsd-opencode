...
Verify phase is a future phase (not started):
...
Do NOT add a "Roadmap Evolution" note - git commit is for record.
...
The commit message preserves historical record of what was removed.
</step>
...
- Don't add "removed phase" notes to STATE.md - git commit is for record
