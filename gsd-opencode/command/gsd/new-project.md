...
3. **Detect existing code (brownfield detection):**
   ...
   **You MUST run all bash commands above using Bash tool before proceeding.**
...
Synthesize all context into `.planning/PROJECT.md` using template from `templates/project.md`.
...
2. Identify what codebase already does
3. These become to initial Validated set
...
<question>
What's standard 2025 stack for [domain]?
</question>
...
- Re-spawn roadmapper with revision context:
  ...
  Update roadmap based on feedback. Edit files in place.
