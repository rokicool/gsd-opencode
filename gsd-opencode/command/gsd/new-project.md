...
Ask inline (freeform, NOT question tool):
...
Based on what they said, ask follow-up questions that dig into their response. Use question tool with options that probe what they mentioned — interpretations, clarifications, concrete examples.
...
When you could write a clear PROJECT.md, use question tool:
...
Ask all workflow preferences in a single question tool call (3 questions):
...
For each category, use question tool:
