...
<objective>
Check project progress, summarize recent work and what's ahead, then intelligently route to next action - either executing an existing plan or creating the next one.
...
A milestone was completed and archived. Ready to start next milestone cycle.

Read MILESTONES.md to find last completed milestone version.
