 ...
 */
export const initNewProject = async (_args, projectDir, _workstream) => {
 ...
 */
export const initProgress = async (_args, projectDir, _workstream) => {
    const config = await loadConfig(projectDir);
 ...
 */
export const initManager = async (_args, projectDir, _workstream) => {
    const config = await loadConfig(projectDir);
    const milestone = await getMilestoneInfo(projectDir);
    const paths = planningPaths(projectDir);
    let rawContent;
