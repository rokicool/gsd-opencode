...
<execution_context>
@$HOME/.config/opencode/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@$HOME/.config/opencode/get-shit-done/workflows/settings-advanced.md`.
