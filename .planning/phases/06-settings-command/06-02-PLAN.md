...
must_haves:
  ...
  artifacts:
    - path: "gsd-opencode/agents/gsd-settings.md"
      provides: "/gsd-settings command prompt with interactive menu"
      contains: "name: gsd-settings"
  key_links:
    - from: "gsd-opencode/agents/gsd-settings.md"
...
Output:
- New command prompt: `gsd-opencode/agents/gsd-settings.md`
</objective>
...
<task type="auto">
  <name>Task 1: Create /gsd-settings command with settings table + interactive loop</name>
  <files>gsd-opencode/agents/gsd-settings.md</files>
  <action>
Create `gsd-opencode/agents/gsd-settings.md` as a user-invoked command prompt (mirrors `gsd-set-profile.md` style).
...
- If `applyProfile()` fails after a config change, clearly report:
  ...
  <verify>
rg -n "^name:\\s*gsd-settings" gsd-opencode/agents/gsd-settings.md
rg -n "@gsd-opencode/get-shit-done/lib/config\\.md" gsd-opencode/agents/gsd-settings.md
rg -n "applyProfile\\(" gsd-opencode/agents/gsd-settings.md
rg -n "\\* = overridden" gsd-opencode/agents/gsd-settings.md
  </verify>
  <done>
- `gsd-opencode/agents/gsd-settings.md` exists and is a complete command prompt (no TODO/placeholder text)
